...
from .models import Project, Message, Skill, Endorsement, Comment, ProjectLanguage, Comment1
...
class ProjectForm_1(ModelForm):
    class Meta:
        model = ProjectLanguage
        fields = ['title','thumbnail','body']

    def __init__(self, *args, **kwargs):
        super(ProjectForm_1, self).__init__(*args, **kwargs)
        self.fields['title'].widget.attrs.update(
            {'class': 'form-control'})
